...
export default function page() {
  ...
  const [form, setForm] = useState({ username: '', email: '', password: '',dept:'' })
  ...
  return (
    <div className='py-14 flex items-center justify-center flex-col gap-5'>
      ...
      <div className='rounded-md py-8 px-3 bg-white shadow-md flex flex-col gap-5 items-center justify-center w-[95%] lg:w-[40%]'>
        ...
        <form action={handleClick} className='flex flex-col gap-5 w-[100%] items-center justify-center'>
          ...
          <Select id="department" className='w-[80%]'  required value={form.dept} onChange={e=>setForm({...form,dept:e.target.value})}>
